...
#define CAMERA_CAPTURE_RATE_FPS CONFIG_CAMERA_CAPTURE_RATE_FPS
#define UDP_HANDSHAKE_TIMEOUT_MS CONFIG_UDP_HANDSHAKE_TIMEOUT_MS
...
extern "C" void app_main(void) {
    ...
    deviceState.camera_fps = CAMERA_CAPTURE_RATE_FPS;
    ...
    do {
        ...
        timeout += 500;
        if (timeout >=UDP_HANDSHAKE_TIMEOUT_MS) {
